...
const ProfilePage = () => {
  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-100 to-white pt-24 px-4">
      <div className="flex flex-col md:flex-row gap-6">
        ...
        {/* Main Content */}
        <div className="flex-1 max-w-7xl bg-white shadow-xl rounded-xl p-6 md:p-10">
          <div className="flex-1 bg-white shadow-xl rounded-xl p-6 md:p-8">
